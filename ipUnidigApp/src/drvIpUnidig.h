...
typedef struct {
    ...
    asynStatus (*clearBits)        (void *drvPvt, asynUser *pasynUser, 
                                    epicsUInt32 mask);
    asynStatus (*readBits)         (void *drvPvt, asynUser *pasynUser, 
                                    epicsUInt32 *value);
    ...
    void (*clearFallingMaskBits)   (void *drvPvt, asynUser *pasynUser, 
                                    epicsUInt32 mask);
    asynStatus (*registerIntCallback) (void *drvPvt, asynUser *pasynUser, 
                                    ipUnidigCallback callback, void *pvt, 
                                    int mask);
    asynStatus (*registerDevCallback) (void *drvPvt, asynUser *pasynUser, 
                                    ipUnidigCallback callback, void *pvt);
} asynIpUnidig;
